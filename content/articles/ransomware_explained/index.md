...
公的機関の説明でも、ランサムウェアは**ファイルを暗号化して使えなくし、身代金を要求する**ものだとされています。 citeturn0search0turn0search1
...
FBIも、添付ファイルやリンク、広告、改ざんされたサイト閲覧などから“気づかないうちに”感染することがあると説明しています。 citeturn0search1
...
また、FBIは「身代金を払ってもデータが戻る保証はない。犯罪を助長する」として、支払いを支持しない立場を明示しています。 citeturn1search0
...
CISAの#StopRansomwareガイドは、組織がランサムウェアの可能性と影響を下げるための実務的な対策をまとめています。 citeturn0search0turn1search1
...
実例として、英国の医療機関でもWannaCry（2017年5月12日）の影響に関するケーススタディが公開されています。 citeturn0search3
...
- **WannaCry（2017年）**：  
  世界的に広がった大規模攻撃。医療機関でも影響が出た事例が公的にまとめられています。 citeturn0search3turn0search7  
  **教訓**：更新（パッチ）や基本的な防御の重要性。
- **Colonial Pipeline（2021年）**：  
  米国の燃料供給に関わる企業が攻撃を受け、社会的な混乱（給油の行列など）につながりました。CISAも“学んだこと”を整理しています。 citeturn0search6turn0search2  
...
## 10. まとめ（覚えておく一言）
- ランサムウェアは「**データに鍵をかけて身代金を要求する**」サイバー犯罪。 citeturn0search1turn0search0
- **払っても戻る保証はない**。犯罪を助長するので支払いは推奨されないことが多い。 citeturn1search0
- いちばん効く基本は **バックアップ・更新・多要素認証・訓練**。
- “いつか自分も”ではなく、**「今日のうちに備える」**のが現実的。

---
### 参考（公的機関など）
- CISA: StopRansomware（ガイド） citeturn0search0turn1search1
- FBI: Ransomware（被害者向け案内） citeturn0search1turn1search0
- NHS England: WannaCryケーススタディ citeturn0search3
- NCSC（英国）: ランサム支払い検討時のガイダンス citeturn1search2
